...
struct Home: View {
    ...
    func HeaderView() -> some View {
        ...
        .onChange(of: currentWeekIndex, initial: false) { oldValue, newValue in
            /// Create when reaches first/last page
                ...
                VStack(spacing: 8) {
                    ...
                    Text(day.date.format("dd"))
                        ...
                        .background(content: {
                            ...
                            /// Indicator to show, whitc is today's day
                            if day.date.isToday {
                                Circle()
                                    .fill(.cyan)
            ...
            GeometryReader {
                ...
                Color.clear
                    ...
                    .onPreferenceChange(OffsetKey.self) { value in
                        /// When the offset reaches 15 and if the creatWeek is toggled then simply generation next set of week
